                            ...
                            <div className="relative backdrop-blur-md bg-white/5 p-8 rounded-2xl border border-white/10 shadow-xl">
                                ...
                                <div className="space-y-4 text-rose-100 leading-relaxed">
                                    ...
                                    <p className="drop-shadow-md">
                                        ...
                                        optimization. Whether I'm collaborating with C-suite executives, mentoring creative teams, 
                                        or architecting campaigns across 15+ client portfolios, I bring the same relentless focus on ROI 
                                        and brand growth.
                                    </p>
                                    <p className="font-semibold text-rose-400 drop-shadow-lg">
                    ...
                    <div className="relative backdrop-blur-md bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-8 lg:p-12 border border-white/20 shadow-2xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="backdrop-blur-md bg-gradient-to-br from-rose-800/20 to-rose-200/20 p-6 rounded-xl border border-white/20 hover:border-rose-400 hover:-translate-y-1 transition-all duration-300 group/card shadow-lg">
                                ...
                                <p className="text-gray-100 mb-4 leading-relaxed drop-shadow-md">
                                    <span className="text-rose-400 font-semibold">I don't just create content!</span> I engineer campaigns that deliver measurable business outcomes. My focus on cost optimization and ROI has saved companies thousands while increasing performance.
                                </p>
                                <div className="text-sm font-semibold text-rose-400">
