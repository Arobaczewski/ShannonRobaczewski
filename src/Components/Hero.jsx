                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    <div className="order-2 lg:order-1 flex flex-col justify-center space-y-8">
                        <div className="relative group">
                            ...
                            <div className="relative backdrop-blur-md bg-gradient-to-r from-black/10 via-transparent to-black/10 p-8 rounded-3xl border border-white/20 shadow-2xl hover:shadow-rose-400/20 hover:shadow-2xl transition-shadow duration-300">
