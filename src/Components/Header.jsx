            ...
            <header className="flex justify-between items-center text-rose-400 py-5 mx-auto relative z-20">
                ...
                <nav className="hidden md:block">
                    <div className="relative group">
                        ...
                        <div className="relative mr-5 backdrop-blur-md  bg-gradient-to-br from-black/20 via-transparent to-black/20 p-2 rounded-2xl border border-white/10 shadow-xl z-20">
