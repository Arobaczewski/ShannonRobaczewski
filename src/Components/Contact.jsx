                    ...
                    <div className="space-y-8">
                        <div className="relative group">
                            ...
                            <div className="relative backdrop-blur-md bg-white/5 p-8 rounded-2xl border border-white/10 shadow-xl">
                                <h3 className="text-2xl font-bold text-rose-100 mb-6 drop-shadow-lg">Get In Touch</h3>
                        ...
                        <div className="space-y-6">
                            {/* Email Contact */}
                            <div className="relative group">
                                <div className="absolute -inset-1 bg-gradient-to-r from-rose-300/10 to-rose-400/10 rounded-xl blur-lg opacity-0 group-hover:opacity-100 transition duration-500"></div>
                                <div className="relative flex items-center gap-4 p-4 backdrop-blur-md bg-white/5 rounded-xl border border-white/10 hover:border-rose-400/50 transition-all duration-300 shadow-lg">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:Srobaczewski@yahoo.com" className="text-rose-100 font-semibold hover:text-rose-300 transition-colors duration-200 drop-shadow-lg">
                                            Srobaczewski@yahoo.com
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                {error && (
                                    <div className="p-4 backdrop-blur-md bg-red-500/20 border border-red-400/30 rounded-lg animate-fade-in shadow-lg">
                                        <p className="text-red-200 text-sm font-medium drop-shadow-md">
                                            ...
                                            <a 
                                                href="mailto:Srobaczewski@yahoo.com" 
