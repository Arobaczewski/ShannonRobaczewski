            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mt-12">
                    <div className="relative group inline-block">
                        ...
                        <div className="relative backdrop-blur-md bg-gradient-to-br from-black/30 via-transparent to-black/20 px-6 py-3 rounded-2xl border border-white/10 shadow-lg">
